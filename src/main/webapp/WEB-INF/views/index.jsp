            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">감염 현황</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">오늘의 전염 상황</li>
                        </ol>
                        <div class="row">
                        <!-- 일일 총 확진자 수 가져와서 확진자 수에 맞는 카드 출력하기  -->
                            <div class="col-xl-3 col-md-6 info1">
                                <div class="card bg-primary text-white mb-4" >
                                    <div class="card-body">추가 확진자 0명!!</div>
                             ...
                             <div class="col-xl-3 col-md-6 info2" >
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">양호 - 확진자 50명 미만</div>
                                    <!-- <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div> -->
                            ...
                            <div class="col-xl-3 col-md-6 info3">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">경고 - 확진자 50 ~ 100명</div>
                                   <!--  <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div> -->
                            ...
                            <div class="col-xl-3 col-md-6 info4">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">위험! - 확진자 100명 이상</div>
                                    <!-- <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div> -->
